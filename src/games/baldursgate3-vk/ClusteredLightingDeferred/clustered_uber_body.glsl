// ============================================================================
// LOCAL LIGHT SHADOW DEBUG MODES
// Enable ONE at a time, then hot-reload via DevKit (devkit_load_live_shaders).
// All modes affect the FIRST point-light shadow loop (hero/dialogue lights).
// ============================================================================
// #define DBG_SHADOW_SINGLE_TAP      // Mode 1: Disable PCF, single center sample only
// #define DBG_SHADOW_STATIC_ROTATION // Mode 2: Replace IGN with constant 0 (no per-pixel rotation)
// #define DBG_SHADOW_ZERO_BIAS       // Mode 3: Zero normal bias (remove 3.5x offset)
// #define DBG_SHADOW_VIS_UV          // Mode 4: Visualize shadow UV coords as color (early-out)
// #define DBG_SHADOW_VIS_DEPTH_DELTA // Mode 5: Visualize |compDepth - atlasDepth| (early-out)
// #define DBG_SHADOW_VIS_TILE_SIZE   // Mode 6: Visualize tile size (tileMax - tileMin) as brightness
// ============================================================================
...
layout(set = 3, binding = 2, r8) uniform readonly image2D rdx_shadowFactorOut;
...
void main()
{
    do
    {
        ...
        float _929 = _541.x;
        float _930 = _541.y;
#ifdef DBG_SHADOW_STATIC_ROTATION
        float _935 = 0.0;
#else
        float _935 = fract(52.98291778564453125 * fract(fma(0.067110560834407806396484375, _929, 0.005837149918079376220703125 * _930)));
#endif
#ifdef DBG_SHADOW_ZERO_BIAS
        const float _rdx_bias_scale = 0.0;
#else
        const float _rdx_bias_scale = 3.5;
#endif
                    ...
                    if (_9514 < (1.0 / _9518))
                    {
                        ...
                        if ((_11._m0[_9480]._m7 & 1u) != 0u)
                        {
                            ...
                            do
                            {
                                ...
                                {
                                    vec4 _9613 = _22._m0[_9579]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_9533)))) * (_22._m0[_9579]._m4 * sqrt(_9514)))), 1.0);
                                    ...
                                    float _9641 = rdx_shadow_pcf(_23, _14, _9620, _9629, _9635, _9636, _9639, _21._m33, ivec2(_529), _46, _47);
                                    if (_9641 < 0.0) return;
                                    _9682 = _9634;
                    ...
                    if (_9810 < (1.0 / _9814))
                    {
                        ...
                        if ((_11._m0[_9778]._m7 & 1u) != 0u)
                        {
                            ...
                            do
                            {
                                ...
                                {
                                    vec4 _9899 = _22._m0[_9865]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_9829)))) * (_22._m0[_9865]._m4 * sqrt(_9810)))), 1.0);
                                    ...
                                    float _9927 = rdx_shadow_pcf(_23, _14, _9906, _9915, _9921, _9922, _9925, _21._m33, ivec2(_529), _46, _47);
                                    if (_9927 < 0.0) return;
                                    _9968 = _9920;
                    ...
                    if (all(lessThan(abs(_10104 - vec3(0.5)), vec3(0.5))))
                    {
                        ...
                        if ((_13._m0[_10064]._m8 & 1u) != 0u)
                        {
                            ...
                            do
                            {
                                ...
                                {
                                    vec4 _10244 = _22._m0[_10212]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_10121)))) * _22._m0[_10212]._m4)), 1.0);
                                    ...
                                    float _10268 = rdx_shadow_pcf(_23, _14, _10247, _10256, _10262, _10263, _10266, _21._m33, ivec2(_529), _46, _47);
                                    if (_10268 < 0.0) return;
                                    _10309 = _10261;
                        ...
                        if (_8216 < (1.0 / _8220))
                        {
                            ...
                            if ((_11._m0[_8182]._m7 & 1u) != 0u)
                            {
                                ...
                                do
                                {
                                    ...
                                    {
                                        vec4 _8315 = _22._m0[_8281]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_8235)))) * (_22._m0[_8281]._m4 * sqrt(_8216)))), 1.0);
                                        ...
                                        float _8343 = rdx_shadow_pcf(_23, _14, _8322, _8331, _8337, _8338, _8341, _21._m33, ivec2(_529), _46, _47);
                                        if (_8343 < 0.0) return;
                                        _8384 = _8336;
                        ...
                        if (_8616 < (1.0 / _8620))
                        {
                            ...
                            if ((_11._m0[_8584]._m7 & 1u) != 0u)
                            {
                                ...
                                do
                                {
                                    ...
                                    {
                                        vec4 _8705 = _22._m0[_8671]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_8635)))) * (_22._m0[_8671]._m4 * sqrt(_8616)))), 1.0);
                                        ...
                                        float _8733 = rdx_shadow_pcf(_23, _14, _8712, _8721, _8727, _8728, _8731, _21._m33, ivec2(_529), _46, _47);
                                        if (_8733 < 0.0) return;
                                        _8774 = _8726;
                        ...
                        if (all(lessThan(abs(_9014 - vec3(0.5)), vec3(0.5))))
                        {
                            ...
                            if ((_13._m0[_8974]._m8 & 1u) != 0u)
                            {
                                ...
                                do
                                {
                                    ...
                                    {
                                        vec4 _9154 = _22._m0[_9122]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_9031)))) * _22._m0[_9122]._m4)), 1.0);
                                        ...
                                        float _9178 = rdx_shadow_pcf(_23, _14, _9157, _9166, _9172, _9173, _9176, _21._m33, ivec2(_529), _46, _47);
                                        if (_9178 < 0.0) return;
                                        _9219 = _9171;
                            ...
                            if (_6597 < (1.0 / _6601))
                            {
                                ...
                                if ((_11._m0[_6563]._m7 & 1u) != 0u)
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        {
                                            vec4 _6696 = _22._m0[_6662]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_6615)))) * (_22._m0[_6662]._m4 * _6675))), 1.0);
                                            ...
                                            float _6724 = rdx_shadow_pcf(_23, _14, _6703, _6712, _6718, _6719, _6722, _21._m33, ivec2(_529), _46, _47);
                                            if (_6724 < 0.0) return;
                                            _6765 = _6717;
                            ...
                            if (_7076 < (1.0 / _7080))
                            {
                                ...
                                if ((_11._m0[_7044]._m7 & 1u) != 0u)
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        {
                                            vec4 _7165 = _22._m0[_7131]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_7094)))) * (_22._m0[_7131]._m4 * _7144))), 1.0);
                                            ...
                                            float _7193 = rdx_shadow_pcf(_23, _14, _7172, _7181, _7187, _7188, _7191, _21._m33, ivec2(_529), _46, _47);
                                            if (_7193 < 0.0) return;
                                            _7234 = _7186;
                            ...
                            if (all(lessThan(abs(_7572 - vec3(0.5)), vec3(0.5))))
                            {
                                ...
                                if ((_13._m0[_7532]._m8 & 1u) != 0u)
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        {
                                            vec4 _7712 = _22._m0[_7680]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_7588)))) * _22._m0[_7680]._m4)), 1.0);
                                            ...
                                            float _7736 = rdx_shadow_pcf(_23, _14, _7715, _7724, _7730, _7731, _7734, _21._m33, ivec2(_529), _46, _47);
                                            if (_7736 < 0.0) return;
                                            _7777 = _7729;
                                ...
                                if (_5090 < (1.0 / _5094))
                                {
                                    ...
                                    if ((_11._m0[_5056]._m7 & 1u) != 0u)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                vec4 _5189 = _22._m0[_5155]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_5108)))) * (_22._m0[_5155]._m4 * _5168))), 1.0);
                                                ...
                                                float _5217 = rdx_shadow_pcf(_23, _14, _5196, _5205, _5211, _5212, _5215, _21._m33, ivec2(_529), _46, _47);
                                                if (_5217 < 0.0) return;
                                                _5258 = _5210;
                                ...
                                if (_5535 < (1.0 / _5539))
                                {
                                    ...
                                    if ((_11._m0[_5503]._m7 & 1u) != 0u)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                vec4 _5624 = _22._m0[_5590]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_5553)))) * (_22._m0[_5590]._m4 * _5603))), 1.0);
                                                ...
                                                float _5652 = rdx_shadow_pcf(_23, _14, _5631, _5640, _5646, _5647, _5650, _21._m33, ivec2(_529), _46, _47);
                                                if (_5652 < 0.0) return;
                                                _5693 = _5645;
                                ...
                                if (all(lessThan(abs(_5997 - vec3(0.5)), vec3(0.5))))
                                {
                                    ...
                                    if ((_13._m0[_5957]._m8 & 1u) != 0u)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            {
                                                vec4 _6137 = _22._m0[_6105]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_6013)))) * _22._m0[_6105]._m4)), 1.0);
                                                ...
                                                float _6161 = rdx_shadow_pcf(_23, _14, _6140, _6149, _6155, _6156, _6159, _21._m33, ivec2(_529), _46, _47);
                                                if (_6161 < 0.0) return;
                                                _6202 = _6154;
                                ...
                                if ((_11._m0[_3428]._m6 & (1u << (_617 & 31u))) != 0u)
                                {
                                    ...
                                    if (_3462 < (1.0 / _3466))
                                    {
                                        ...
                                        if ((_11._m0[_3428]._m7 & 1u) != 0u)
                                        {
                                            ...
                                            vec4 _3540 = _22._m0[_3518]._m0 * vec4(_859 + (_3465 * (_rdx_bias_scale * (_22._m0[_3518]._m4 * sqrt(_3462)))), 1.0);
                                            ...
                                            float _3568 = rdx_shadow_pcf(_23, _14, _3547, _3556, _3562, _3563, _3566, _21._m33, ivec2(_529), _46, _47);
                                            if (_3568 < 0.0) return;
                                            _3611 = _3561;
                                            _3612 = _3419 ? _3419 : true;
                                            _3613 = mix(1.0, _3568, spvNMin(_942, _11._m0[_3428]._m8));
                                        }
                                        else
                                        {
                                            _3611 = _3417;
                                ...
                                if ((_11._m0[_3940]._m6 & (1u << (_617 & 31u))) != 0u)
                                {
                                    ...
                                    if (_3972 < (1.0 / _3976))
                                    {
                                        ...
                                        if ((_11._m0[_3940]._m7 & 1u) != 0u)
                                        {
                                            ...
                                            vec4 _4040 = _22._m0[_4018]._m0 * vec4(_859 + (_3975 * (_rdx_bias_scale * (_22._m0[_4018]._m4 * sqrt(_3972)))), 1.0);
                                            ...
                                            float _4068 = rdx_shadow_pcf(_23, _14, _4047, _4056, _4062, _4063, _4066, _21._m33, ivec2(_529), _46, _47);
                                            if (_4068 < 0.0) return;
                                            _4111 = _4061;
                                            _4112 = _3931 ? _3931 : true;
                                            _4113 = mix(1.0, _4068, spvNMin(_942, _11._m0[_3940]._m8));
                                        }
                                        else
                                        {
                                            _4111 = _3929;
                                ...
                                if (((_13._m0[_4440]._m4 & 16777215u) & (1u << (_617 & 31u))) != 0u)
                                {
                                    ...
                                    if (all(lessThan(abs(_4480 - vec3(0.5)), vec3(0.5))))
                                    {
                                        ...
                                        if ((_13._m0[_4440]._m8 & 1u) != 0u)
                                        {
                                            ...
                                            vec4 _4599 = _22._m0[_4579]._m0 * vec4(_859 + (_13._m0[_4440]._m9 * (_rdx_bias_scale * _22._m0[_4579]._m4)), 1.0);
                                            ...
                                            float _4623 = rdx_shadow_pcf(_23, _14, _4602, _4611, _4617, _4618, _4621, _21._m33, ivec2(_529), _46, _47);
                                            if (_4623 < 0.0) return;
                                            _4666 = _4616;
                                            _4667 = _4431 ? _4431 : true;
                                            _4668 = mix(1.0, _4623, spvNMin(_942, _13._m0[_4440]._m5));
                                        }
                                        else
                                        {
                                            _4666 = _4429;
                                        ...
                                        if (_2352 < (1.0 / _2356))
                                        {
                                            ...
                                            if ((_11._m0[_2318]._m7 & 1u) != 0u)
                                            {
                                                ...
                                                do
                                                {
                                                    ...
                                                    {
                                                        vec4 _2451 = _22._m0[_2417]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_2371)))) * (_22._m0[_2417]._m4 * sqrt(_2352)))), 1.0);
                                                        ...
                                                        float _2479 = rdx_shadow_pcf(_23, _14, _2458, _2467, _2473, _2474, _2477, _21._m33, ivec2(_529), _46, _47);
                                                        if (_2479 < 0.0) return;
                                                        _2520 = _2472;
                                        ...
                                        if (_2690 < (1.0 / _2694))
                                        {
                                            ...
                                            if ((_11._m0[_2658]._m7 & 1u) != 0u)
                                            {
                                                ...
                                                do
                                                {
                                                    ...
                                                    {
                                                        vec4 _2779 = _22._m0[_2745]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_2709)))) * (_22._m0[_2745]._m4 * sqrt(_2690)))), 1.0);
                                                        ...
                                                        float _2807 = rdx_shadow_pcf(_23, _14, _2786, _2795, _2801, _2802, _2805, _21._m33, ivec2(_529), _46, _47);
                                                        if (_2807 < 0.0) return;
                                                        _2848 = _2800;
                                        ...
                                        if (all(lessThan(abs(_3026 - vec3(0.5)), vec3(0.5))))
                                        {
                                            ...
                                            if ((_13._m0[_2986]._m8 & 1u) != 0u)
                                            {
                                                ...
                                                do
                                                {
                                                    ...
                                                    {
                                                        vec4 _3166 = _22._m0[_3134]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_3043)))) * _22._m0[_3134]._m4)), 1.0);
                                                        ...
                                                        float _3190 = rdx_shadow_pcf(_23, _14, _3169, _3178, _3184, _3185, _3188, _21._m33, ivec2(_529), _46, _47);
                                                        if (_3190 < 0.0) return;
                                                        _3231 = _3183;
                                            ...
                                            if (_1036 < (1.0 / _1040))
                                            {
                                                ...
                                                if ((_11._m0[_1002]._m7 & 1u) != 0u)
                                                {
                                                    ...
                                                    do
                                                    {
                                                        ...
                                                        {
                                                            vec4 _1135 = _22._m0[_1101]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_1055)))) * (_22._m0[_1101]._m4 * sqrt(_1036)))), 1.0);
                                                            ...
                                                            float _1163 = rdx_shadow_pcf(_23, _14, _1142, _1151, _1157, _1158, _1161, _21._m33, ivec2(_529), _46, _47);
                                                            if (_1163 < 0.0) return;
                                                            _1204 = _1156;
                                            ...
                                            if (_1442 < (1.0 / _1446))
                                            {
                                                ...
                                                if ((_11._m0[_1410]._m7 & 1u) != 0u)
                                                {
                                                    ...
                                                    do
                                                    {
                                                        ...
                                                        {
                                                            vec4 _1531 = _22._m0[_1497]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_1461)))) * (_22._m0[_1497]._m4 * sqrt(_1442)))), 1.0);
                                                            ...
                                                            float _1559 = rdx_shadow_pcf(_23, _14, _1538, _1547, _1553, _1554, _1557, _21._m33, ivec2(_529), _46, _47);
                                                            if (_1559 < 0.0) return;
                                                            _1600 = _1552;
                                            ...
                                            if (all(lessThan(abs(_1846 - vec3(0.5)), vec3(0.5))))
                                            {
                                                ...
                                                if ((_13._m0[_1806]._m8 & 1u) != 0u)
                                                {
                                                    ...
                                                    do
                                                    {
                                                        ...
                                                        {
                                                            vec4 _1986 = _22._m0[_1954]._m0 * vec4(_859 + (_673 * ((_rdx_bias_scale * float(int(sign(_1863)))) * _22._m0[_1954]._m4)), 1.0);
                                                            ...
                                                            float _2010 = rdx_shadow_pcf(_23, _14, _1989, _1998, _2004, _2005, _2008, _21._m33, ivec2(_529), _46, _47);
                                                            if (_2010 < 0.0) return;
                                                            _2051 = _2003;
        ...
        // --- Shadow system modes ---
        if (pc.rendering_temporal_shadows > 2.5 && pc.rendering_temporal_shadows < 3.5) {
            // Mode 3: visualize binding 2 (LocalShadowResolve output)
            float s = imageLoad(rdx_shadowFactorOut, ivec2(_529)).r;
            imageStore(_46, ivec2(_529), vec4(s, s, s, 1.0));
            imageStore(_47, ivec2(_529), vec4(0.0));
            break;
        }
        if (pc.rendering_temporal_shadows > 1.5 && pc.rendering_temporal_shadows < 2.5) {
            // Mode 2: visualize what binding 3 contains (debug)
            float h = texelFetch(rdx_temporalShadowHistory, ivec2(_529), 0).r;
            imageStore(_46, ivec2(_529), vec4(h, h, h, 1.0));
            imageStore(_47, ivec2(_529), vec4(0.0));
            break;
        }
